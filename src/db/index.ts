...
sqlite.exec(`
  CREATE TABLE IF NOT EXISTS firearms (
    ...
    serial TEXT,
    no_serial INTEGER NOT NULL DEFAULT 0,
    nsn TEXT,
    generation TEXT,
    type TEXT NOT NULL,
    purchase_date TEXT,
...
if (!firearmColumns.includes('no_serial'))               sqlite.exec("ALTER TABLE firearms ADD COLUMN no_serial INTEGER NOT NULL DEFAULT 0");
